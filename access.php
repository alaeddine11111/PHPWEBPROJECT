    ...
    <div class="gate-container">
        <div class="gate-card">
            <div class="gate-header">
                ...
                <p class="subtitle">Enter website password to continue</p>
            </div>
            ...
            <form method="POST">
                <div class="form-group">
                    <label for="website_password">
                        <i class="bi bi-key me-2"></i>Website Password
                    </label>
                    <input 
                        type="password" 
                        class="form-control" 
                ...
                <button type="submit" class="btn btn-enter">
                    <i class="bi bi-unlock me-2"></i>Enter
                </button>
            </form>

            <div class="credentials-hint">
                <strong>Demo Password:</strong><br>
                <code>website2024</code>
            </div>
        </div>
    </div>
